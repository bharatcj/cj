...
if($row2>0)
{
     $to = $row2['email']; // this is your Email address
    $from = "bharatchijay@gmail.com"; // this is the sender's Email address
    $subject = "Information about your password";
    $password=$row2['password'];
    $fname = $row2['fname'];
    $token = md5($femail);
    $link = "https://samuhafoundation.org/cj/loginsystem/reset-password.php?key=".$token;
$message = 'Click On This Link to Reset Password '.$link.'';
      $headers = "MIME-Version: 1.0" . "\r\n";
  $headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
  $headers .= 'From: <bharatchijay@gmail.com>' . "\r\n";
  $bodyContent = 'Dear'." ".$fname.", ";
$bodyContent .= $message;
    mail($to,$subject,$bodyContent,$headers);
     echo "<script>alert('Hello $fname, Password has been shared to you mail ID');</script>";
}
else
{
