...
if($_FILES['file']['name'] != '')
	...
	$threes = rand() . '.' . $extension[1];
	$destination = './upload/' . $threes;
    ...
    $msg=mysqli_query($con,"update users set fname='$fname',lname='$lname',contactno='$contact', address='$address', dob='$dob', file='$threes' where id='$userid'");
                     ...
                     <form method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                <table class="table table-bordered">
                                   ...
                                   <tr>
                                       <th>Address</th>
                                       <td colspan="3"><input class="form-control" id="address" name="address" type="text" value="<?php echo $result['address'];?>"  /></td>
                                   </tr>
                                   <tr>
                                       <th>Date of Birth</th>
                                       <td colspan="3"><input class="form-control" id="dob" name="dob" type="date" value="<?php echo $result['dob'];?>"  /></td>
                                   </tr>
                                   <tr>
                                       <th>Profile Pic</th>
                                       <td colspan="3"><input class="form-control" id="file" name="file" type="file"  /><br/>
                                       <img src="upload/<?php echo $result['file'];?>" class="thumbnail" width="20%" /></td>
                                   </tr>
                                   <tr>
                                       <th>Email</th>
